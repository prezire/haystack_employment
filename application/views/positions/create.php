<div id="position" class="create row">
  ...
  <div class="row">
    ...
    <div class="small-12 medium-6 large-6 columns">Description*: <textarea name="description"><?php echo set_value('description'); ?></textarea></div>
    ...
    <div class="small-12 medium-6 large-6 columns">Working Hours*: <input type="text" name="working_hours" value="<?php echo set_value('working_hours'); ?>" /></div>
    ...
    <div class="small-12 medium-6 large-6 columns">Vacancy Count*: <input type="text" name="vacancy_count" value="<?php echo set_value('vacancy_count'); ?>" /></div>
