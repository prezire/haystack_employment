<div id="resume" class="create row">
  ...
  <section>
        ...
        <div class="details">
          <span>
            <label>Name*:</label>
              <input type="text"  
                    class="name"  />
              <a href="<?php echo site_url('resume/create'); ?>" class="button tiny btnUpdateResume">
                Update
              </a>
            </span>
            <span class="options">
    ...
    <section class="resume">
      <div class="row">
        <div class="small-11 medium-11 large-11 columns">
          <h5>
            ...
            <a href="<?php echo site_url('user/create/' . getLoggedUser()->id); ?>">
              Profile
            </a>)
          </h5>
        </div>
      ...
      <?php echo form_open('resume/create'); ?>
    ...
    <section class="workHistories">
      ...
      <?php echo form_open('workhistory/create'); ?>
        <div class="row">
        ...
        <ul>
          <?php foreach($workHistories as $w){ ?>
            <li>
              <?php echo $this->load->view('resumes/work_histories/create', array('workHistory' => $w), true); ?>
    ...
    <section class="educations">
      ...
      <?php echo form_open('education/create'); ?>
        <div class="row">
        ...
        <ul>
          <?php foreach($educations as $e){ ?>
            <li>
              <?php echo $this->load->view('resumes/educations/create', array('education' => $e), true); ?>
              <a href="#" class="close">&times;</a>
            </li>
          <?php } ?>
        </ul>
    ...
    <section class="skills">
      ...
      <?php echo form_open('skill/create'); ?>
        <div class="row">
    ...
    <section class="certifications">
      ...
      <?php echo form_open('certification/create'); ?>
        <div class="row">
    ...
    <section class="additionalInformations">
      ...
      <?php 
        echo $this->load->view
        (
          'resumes/additional_informations/create', 
          array
          (
            'resume' => $resume, 
