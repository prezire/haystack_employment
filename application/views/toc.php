<div id="toc" class="row">
	...
	<div class="row">
	  <div class="small-12 medium-12 large-12 columns">
		...
		Simplifie JobFormity runs an online service called Simplifie JobFormity, found at JobFormity.simplifie.net ("Website"). All of your Content (as defined below) can be shared with the public and may be shared automatically. Please be careful to review how all of your Content is being shared to ensure you are vigilant in protecting your privacy. If you have any questions, feel free to email us at <a href="<?php echo site_url('main/about'); ?>"><?php echo site_url('main/about'); ?></a>.

		<strong>The Terms</strong>
		The following terms and conditions govern all use of the website and all Content, services and products available at or through the Website. For purposes of these Terms of Service, the term "Content" includes, without limitation, videos, audio clips, written posts and comments, information, data, text, photographs, software, scripts, graphics, and interactive features generated, provided, or otherwise made accessible on or through this Website. The Website is owned and operated by Simplifie JobFormity. ("Simplifie JobFormity"). The Website is offered subject to your acceptance without modification of all of the terms and conditions contained herein and all other operating rules, policies (including, without limitation, Simplifie JobFormity’s Privacy Policy) and procedures that may be published from time to time on this Site by Simplifie JobFormity (collectively, the "Agreement").

		Please read this Agreement carefully before accessing or using the Website. By accessing or using any part of the website, you agree to become bound by the terms and conditions of this agreement. If you do not agree to all the terms and conditions of this agreement, then you may not access the Website or use any services. If these terms and conditions are considered an offer by Simplifie JobFormity, acceptance is expressly limited to these terms. The Website is available only to individuals who are at least 14 years old.
		...
		Publications, products, content or services referenced herein or on our website are the exclusive trademarks or servicemarks of our Simplifie JobFormity website or related parties. Other product and company names mentioned in our website may be the trademarks of their respective owners.
		...
		<strong>Your Duty To Other Users</strong>
		...
		We may disable your user ID and password at our sole discretion or if you breach any of the policies or terms governing your use of our Simplifie JobFormity website or any other contractual obligation you owe to us.
		...
		The content may contain inaccuracies or typographical errors. Our JobFormity.simplifie.net website makes no representations about the accuracy, reliability, completeness, or timeliness of the content or about the results to be obtained from using our website or the content on it. Use of our website and the content is at your own risk. Changes are periodically made to our website, and may be made at any time.
		...
		<strong>Express Disclaimer of Consequential Damages</strong>
		...
		<strong>Social Media Warning (Divulgence of Personal and Private Information)</strong>
		...
		This Agreement, in whole or in part, may be terminated by Simplifie JobFormity without notice at any time for any reason. The provisions of paragraphs 1 (Copyright, Licenses and Idea Submissions), 2 (Use of the Service), 3 (Indemnification), 4 (Third Party Rights), 6 (Hiring an Attorney / No Attorney-Client Relationship), and 7 (Miscellaneous) shall survive any termination of this Agreement, in whole or in part.

		<strong>Governing Law</strong>
		This Agreement shall treated as though executed, set in force, and performed in the country of the United States Accordingly, it shall be governed and construed in accordance with the laws of the Philippines in terms of those applicable to agreements, without regard to conflict of law principles.

		<strong>Disputes</strong>
		Any cause of action by you with respect to our website must be instituted within one (1) year after the cause of action arose or be forever waived and barred. All actions shall be subject to the limitations set forth in these Terms of Service and Conditions of Use. Any legal claim arising out of or relating to these Terms of Service and Conditions of Use or our website, excluding intellectual property right infringement and other claims by us, shall be settled confidentially through mandatory binding arbitration per the American Arbitration Association commercial arbitration rules. The arbitration shall be conducted in Cebu City, Philippines. Each party shall bear one half of the arbitration fees and costs incurred, and each party shall bear its own lawyer fees. All claims shall be arbitrated on an individual basis, and shall not be consolidated in any arbitration with any claim or controversy of any other party.
		...
		<strong>This Agreement Prevails</strong>
		...
		Any rights not expressly granted herein are reserved to Simplifie JobFormity.

		<strong>Change Notice</strong>
		As with any of our administrative and legal notice pages, the contents of this page can and will change over time. Accordingly, this page could read differently as of your very next visit. These changes are necessitated, and carried out by Simplifie JobFormity, in order to protect you and our JobFormity.simplifie.net website. If this page is important to you, you should check back frequently as no other notice of changed content will be provided either before or after the change takes effect.

		<strong>Copyright Warning</strong>
		The legal notices and administrative pages on this website, including this one, have been diligently drafted by an attorney. We at Simplifie JobFormity have paid to license the use of these legal notices and administrative pages on JobFormity.simplifie.net for your protection and ours. This material may not be used in any way for any reason and unauthorized use is policed via Copyscape to detect violators.

		<strong>Questions / Comments / Concerns</strong>
		If you have any questions about the contents of this page, or simply wish to reach us for any other reason, you may do so by emailing us at <a href="<?php echo site_url('main/about'); ?>"><?php echo site_url('main/about'); ?></a>.
		</div>
	</div>
</div>