<div id="toc" class="row">
	...
	<div class="row">
	  <div class="small-12 medium-12 large-12 columns">
		...
		Simplifie Haystack runs an online service called Simplifie Haystack, found at haystack.simplifie.net ("Website"). All of your Content (as defined below) can be shared with the public and may be shared automatically. Please be careful to review how all of your Content is being shared to ensure you are vigilant in protecting your privacy. If you have any questions, feel free to email us at <?php echo site_url('main/about'); ?>.

		<strong>The Terms</strong>
		The following terms and conditions govern all use of the website and all Content, services and products available at or through the Website. For purposes of these Terms of Service, the term "Content" includes, without limitation, videos, audio clips, written posts and comments, information, data, text, photographs, software, scripts, graphics, and interactive features generated, provided, or otherwise made accessible on or through this Website. The Website is owned and operated by Simplifie Haystack. ("Simplifie Haystack"). The Website is offered subject to your acceptance without modification of all of the terms and conditions contained herein and all other operating rules, policies (including, without limitation, Simplifie Haystack’s Privacy Policy) and procedures that may be published from time to time on this Site by Simplifie Haystack (collectively, the "Agreement").

		Please read this Agreement carefully before accessing or using the Website. By accessing or using any part of the website, you agree to become bound by the terms and conditions of this agreement. If you do not agree to all the terms and conditions of this agreement, then you may not access the Website or use any services. If these terms and conditions are considered an offer by Simplifie Haystack, acceptance is expressly limited to these terms. The Website is available only to individuals who are at least 14 years old.
		...
		Publications, products, content or services referenced herein or on our website are the exclusive trademarks or servicemarks of our Simplifie Haystack website or related parties. Other product and company names mentioned in our website may be the trademarks of their respective owners.
		...
		We may disable your user ID and password at our sole discretion or if you breach any of the policies or terms governing your use of our Simplifie Haystack website or any other contractual obligation you owe to us.
		...
		The content may contain inaccuracies or typographical errors. Our haystack.simplifie.net website makes no representations about the accuracy, reliability, completeness, or timeliness of the content or about the results to be obtained from using our website or the content on it. Use of our website and the content is at your own risk. Changes are periodically made to our website, and may be made at any time.
		...
		This Agreement, in whole or in part, may be terminated by Simplifie Haystack without notice at any time for any reason. The provisions of paragraphs 1 (Copyright, Licenses and Idea Submissions), 2 (Use of the Service), 3 (Indemnification), 4 (Third Party Rights), 6 (Hiring an Attorney / No Attorney-Client Relationship), and 7 (Miscellaneous) shall survive any termination of this Agreement, in whole or in part.
		...
		Any rights not expressly granted herein are reserved to Simplifie Haystack.

		<strong>Change Notice</strong>
		As with any of our administrative and legal notice pages, the contents of this page can and will change over time. Accordingly, this page could read differently as of your very next visit. These changes are necessitated, and carried out by Simplifie Haystack, in order to protect you and our haystack.simplifie.net website. If this page is important to you, you should check back frequently as no other notice of changed content will be provided either before or after the change takes effect.

		<strong>Copyright Warning</strong>
		The legal notices and administrative pages on this website, including this one, have been diligently drafted by an attorney. We at Simplifie Haystack have paid to license the use of these legal notices and administrative pages on haystack.simplifie.net for your protection and ours. This material may not be used in any way for any reason and unauthorized use is policed via Copyscape to detect violators.

		<strong>Questions / Comments / Concerns</strong>
		If you have any questions about the contents of this page, or simply wish to reach us for any other reason, you may do so by emailing us at <?php echo site_url('main/about'); ?>
		</div>
	</div>
</div>