  ...
  <div class="row">
    <div class="small-12 medium-12 large-12 columns">
      <?php echo form_open('auth/login'); ?>
        <div class="large-10 columns"><input type="email" placeholder="Email*" name="email" /></div>
        <div class="large-10 columns"><input type="password" placeholder="Password*" name="password" /></div>
