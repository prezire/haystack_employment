<div id="applicant" class="create">
  <?php echo form_open_multipart('applicant/create'); ?>
      <div class="row">
        ...
        <div class="large-6 columns">Current Position Title: <input type="text" placeholder="e.g. Student, Developer, Manager" name="current_position_title" value="<?php echo set_value('current_position_title'); ?>" /></div>
